<div class="panel panel-default">
  <div class="panel-heading clearfix">
    <h3 class="panel-title pull-left title-custom-button"><?php echo $this->lang->line('usuarios');?></h3>
    <a href="<?php echo base_url().'Admin/Usuario/cadastro';?>" class="btn btn-primary pull-right"><?php echo $this->lang->line('cadastrar');?></a>
  </div>
  <div class="panel-body">
    ...
    ?>
    <form id="form_usuario_busca" name="form_usuario_busca" method="post" action="<?php echo base_url().'Admin/Usuario/index';?>" >
        <div class="row">
