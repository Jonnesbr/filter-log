<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <h3 class="panel-title pull-left title-custom-button">Cliente</h3>
        <a href="<?php echo base_url().'Admin/Cliente/cadastro';?>" class="btn btn-primary pull-right"><?php echo $this->lang->line('cadastrar');?></a>
    </div>
    <div class="panel-body">
        ...
        ?>
        <form id="form_cliente_busca" name="form_cliente_busca" method="post" action="<?php echo base_url().'Admin/Cliente/index';?>" >
            <div class="row">
